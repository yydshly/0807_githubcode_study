...
本目录作为 `0807_githubcode_study` 的独立子项目，保留上游应用并增加了 Windows、MiniMax、Codex 控制与外部视频接力能力。研究结论不是“它能独立担任导演”，而是：AIComicBuilder 适合作为 AI 短剧的生产执行和资产管理层，ChatGPT/Codex 负责主创、审批、审片与返工决策。

- [完整研究报告](REPORT.md)
- [能力与 Codex 控制架构](docs/CAPABILITY_CONTROL_ARCHITECTURE.md)
- [两组视频样例与生产指南](docs/SAMPLE_PRODUCTION_GUIDE.md)
- [Codex CLI / Orchestrator 命令](docs/CODEX_ORCHESTRATION.md)
- [筛选后的两条完整样例](docs/samples/)
