...
- Be visually specific, but stay strictly within every user-specified duration, scene/shot count, character, location, and dialogue limit.
- If the concept asks for exactly N scenes/shots, write exactly N numbered scenes and stop after scene N. Never invent extra dialogue, narration, characters, or an epilogue.`;
}
